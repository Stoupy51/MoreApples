...
#> more_apples:v1.2.2/load/enumerate
#
...
execute if score #more_apples.major load.status matches 1 if score #more_apples.minor load.status matches 2 unless score #more_apples.patch load.status matches 2.. run scoreboard players set #more_apples.patch load.status 2
